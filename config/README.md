...
visual|textual|audio: 
  ...
  items|interactions:
    ...
    [item_column]: <column_for_item_descriptions> # OPTIONAL, the column name for the item description in the tsv file
    
    [interaction_column]: <column_for_interaction_reviews> # OPTIONAL, the column name for the interaction reviews in the tsv file
    
    model: [
      {
        name: <model_name>, # as indicated in the specific backend you are using [1]
        
        output_layers: <list_of_output_layers>, # as indicated in the specific backend you are using [2]
