...
**\[3\]** It is required to put the exact same model name as reported in the related backend's documentation. Here we try to provide useful linkst to list all available pre-trained models for each backend/modality:
